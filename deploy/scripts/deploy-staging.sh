...
export SMTP_HOST SMTP_PORT SMTP_SECURE SMTP_USER SMTP_PASS SMTP_FROM
export FIREBASE_PROJECT_ID FIREBASE_SERVICE_ACCOUNT_JSON_B64 FIREBASE_SERVICE_ACCOUNT_JSON PUSH_MIRROR_EMAIL
export APP_PUBLIC_ORIGIN INVITE_PUBLIC_ORIGIN
